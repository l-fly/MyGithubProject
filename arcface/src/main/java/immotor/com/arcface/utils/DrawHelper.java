...
public class DrawHelper {
    ...
    public static void drawFaceRect(Canvas canvas, DrawInfo drawInfo, int color, int faceRectThickness) {
        ...
        mPath.moveTo(rect.left, rect.top + rect.height() / 10);
        mPath.lineTo(rect.left, rect.top);
        mPath.lineTo(rect.left + rect.width() / 10, rect.top);
        //右上
        mPath.moveTo(rect.right - rect.width() / 10, rect.top);
        mPath.lineTo(rect.right, rect.top);
        mPath.lineTo(rect.right, rect.top + rect.height() / 10);
        //右下
        mPath.moveTo(rect.right, rect.bottom - rect.height() / 10);
        mPath.lineTo(rect.right, rect.bottom);
        mPath.lineTo(rect.right - rect.width() / 10, rect.bottom);
        //左下
        mPath.moveTo(rect.left + rect.width() / 10, rect.bottom);
        mPath.lineTo(rect.left, rect.bottom);
        mPath.lineTo(rect.left, rect.bottom - rect.height() / 10);
