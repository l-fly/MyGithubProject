package immotor.com.mygithubproject.network;
...
import immotor.com.mygithubproject.App;
import immotor.com.mygithubproject.network.api.BiliAppService;
import immotor.com.mygithubproject.utils.CommonUtil;
...
public class RetrofitHelper {
    ...
    static BiliAppService biliAppService;
    public static BiliAppService getBiliAppAPI() {
        if(biliAppService == null){
            synchronized (BiliAppService.class) {
                if(biliAppService == null){
                    biliAppService = createApi(BiliAppService.class, ApiConstants.APP_BASE_URL);
                }
            }
        }
        return biliAppService;
    }
